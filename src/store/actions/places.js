...
export const addPlace = (placeName, location, image) => {
    return dispatch => {
        ...
        dispatch(authGetToken())
            ...
            .then(token => {
                authToken = token;
                return fetch("https://us-central1-awesome-places-1526557212424.cloudfunctions.net/storeImage",{
                    method: "POST",
                    body: JSON.stringify({
                        image: image.base64
                    }),
        ...
        .then(parsedRes => {
            ...
            return fetch("https://awesome-places-1526557212424.firebaseio.com/places.json?auth=" + authToken, {
                method: "POST",
